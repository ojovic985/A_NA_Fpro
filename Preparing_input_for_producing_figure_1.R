...
write.csv(M2_ord,"Compas_scores_Added_to_2404_without_M1_All_food_codes_from_WWEIA_analysis_Incl_dup.csv")
...
write.csv(t(t(R_Fpro_vs_Score)),"Correlation_Fpro_vs_Score_for_17_cat.csv") # Second KEY file for final input for Figure 1
