...
df_train = pd.read_csv("Train_15nutr.csv")
df_train = df_train.drop(df_train.columns[0], axis=1)
df_test = pd.read_csv("Test_15nutr.csv")
...
#Macro-Averaged AUC (Validation): 0.9570
...
for fold, (train_idx, val_idx) in enumerate(cv.split(X, y)):
    ...
    model_cv = RandomForestClassifier(
        n_estimators=200, # rf_random.best_params_['n_estimators'],
        max_features='log2', #rf_random.best_params_['max_features'],
        max_depth=144, # rf_random.best_params_['max_depth'],
        random_state=42, 
        bootstrap=False
    )
...
# Mean AUC over 5 folds: 0.9389 ± 0.0191
...
FPro_train.to_csv("FPro_train_15_nutr_model.csv", index=False)
FPro.to_csv("FPro_test_15_nutr_model.csv", index=False)



df_prediction = pd.read_csv("Finland_15_nutr_for_FPro.csv")
...
FPro_prediction.to_csv("FPro_pred_Finland_15_nutr_for_FPro.csv", index=False)



df_prediction = pd.read_csv("Italy_15_nutr_for_FPro.csv")
...
FPro_prediction.to_csv("FPro_pred_Italy_15_nutr_for_FPro.csv", index=False)



df_prediction = pd.read_csv("Sweden_15_nutr_for_FPro.csv")
...
FPro_prediction.to_csv("FPro_pred_Sweden_15_nutr_for_FPro.csv", index=False)



df_prediction = pd.read_csv("France_15_nutr_for_FPro.csv")
...
FPro_prediction.to_csv("FPro_pred_France_15_nutr_for_FPro.csv", index=False)



df_prediction = pd.read_csv("Germany_15_nutr_for_FPro.csv")
...
FPro_prediction.to_csv("FPro_pred_Germany_15_nutr_for_FPro.csv", index=False)



df_prediction = pd.read_csv("Netherlands_15_nutr_for_FPro.csv")
...
FPro_prediction.to_csv("FPro_pred_Netherlands_15_nutr_for_FPro.csv", index=False)



df_prediction = pd.read_csv("United.Kingdom_15_nutr_for_FPro.csv")
...
FPro_prediction.to_csv("FPro_pred_United.Kingdom_15_nutr_for_FPro.csv", index=False)
