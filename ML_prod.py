...
RFFNDDS20172018=pd.read_csv('./X62_set_2007-2008.csv') #KEY INPUT - Produced from "calculation_of_Fpro.R" file
...
df.to_csv("./A_FNDDS_2007-08_62Nutrients_ensemble_5folds.csv") # already present in A_NA_Fpro/FNDDS_Fpro_calc_prepared
