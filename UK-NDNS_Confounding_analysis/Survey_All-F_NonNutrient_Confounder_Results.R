...
write.csv(Mat_fin,"NonNut_Max&Min_p_val_&coef_final_statistics_with_UK-NDNS_AllF-nonNutrient-svyglm.csv")
...
write.csv(Ha,"NonNut_FPro_p_val_&coef_final_statistics_with_UK-NDNS_AllF-nonNutrient-svyglm.csv")
