...
Q<-read.csv("C1C2_F1_07.csv",header=TRUE)
Q<-Q[,-1]
...
Q<-read.csv("C1C2_F5_07.csv",header=TRUE)
Q<-Q[,-1]
...
#### Goes with Q<-read.csv("C1C2_F5_07.csv",header=TRUE) or with Q<-read.csv("C1C2_F5_08.csv",header=TRUE) ####
...
#### Goes with Q<-read.csv("C1C2_F1_07.csv",header=TRUE) or with Q<-read.csv("C1C2_F1_08.csv",header=TRUE) ####
...
Q<-read.csv("C1C2_F1_07.csv",header=TRUE) # This goes with F15-49
...
Q<-read.csv("C1C2_F1_08.csv",header=TRUE) # Second row # This goes with F15-49
...
Q<-read.csv("C1C2_F5_07.csv",header=TRUE) # This goes with F15-49
...
Q<-read.csv("C1C2_F5_08.csv",header=TRUE) # Fourth row # This goes with F50_plus
...
Q<-read.csv("C1C2_F1_08.csv",header=TRUE)
...
Q<-read.csv("C1C2_F5_08.csv",header=TRUE)
