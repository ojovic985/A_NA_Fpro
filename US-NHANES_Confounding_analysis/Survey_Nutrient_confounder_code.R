...
write.csv(Mat_final,"Max&Min_p_val_&coef_final_statistics_with_US-NHANES_AllF-Nutrient-svyglm.csv")


### And To obtain results for FPro - only:

rownames(Matfull2)<-colnames(Mat1)
write.csv(Matfull2,"FPro_p_val_&coef_final_statistics_with_US-NHANES_AllF-Nutrient-svyglm.csv")
...
write.csv(Mat_final,"Max&Min_p_val_&coef_final_statistics_with_US-NHANES_F15-49-Nutrient-svyglm.csv")

### And To obtain results for FPro - only:

rownames(Matfull2)<-colnames(Mat1)

write.csv(Matfull2,"FPro_p_val_&coef_final_statistics_with_US-NHANES_F15-49-Nutrient-svyglm.csv")
