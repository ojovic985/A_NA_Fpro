...
B<-read.csv("Xnum_and_Xfum_1hotencoded_Merged_FullSer_C-P_minBPX.csv",header=TRUE) #This file isn't here because it would be too large, it is obtained from A_NA_Fpro/Datasets/how_datasets_were_created.R
B<-B[,-1]
