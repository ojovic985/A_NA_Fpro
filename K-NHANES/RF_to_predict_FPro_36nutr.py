...
df_train = pd.read_csv("Train_36nutr.csv")
df_train = df_train.drop(df_train.columns[0], axis=1)
df_test = pd.read_csv("Test_36nutr.csv")
...
#Validation Accuracy: 0.898972602739726
...
#Macro-Averaged AUC (Validation): 0.9807
...
FPro_train.to_csv("FPro_train_36_nutr_model.csv", index=False)
FPro.to_csv("FPro_test_36_nutr_model.csv", index=False)


df_prediction = pd.read_csv("log_ie_FPro-ready_F_codes_nutr_cont­_of_hn15_24rc.csv")
...
FPro_prediction.to_csv("FPro_prediction_F_codes_nutr_cont_of_hn15_24rc.csv", index=False)


df_prediction = pd.read_csv("log_ie_FPro-ready_F_codes_nutr_cont­_of_hn14_24rc.csv")
...
FPro_prediction.to_csv("FPro_prediction_F_codes_nutr_cont_of_hn14_24rc.csv", index=False)


df_prediction = pd.read_csv("log_ie_FPro-ready_F_codes_nutr_cont­_of_hn13_24rc.csv")
...
FPro_prediction.to_csv("FPro_prediction_F_codes_nutr_cont_of_hn13_24rc.csv", index=False)
