...
write.csv(Mat_fin,"NonNut_Max&Min_p_val_&coef_final_statistics_with_KNHANES_F15-49-nonNutrient-svyglm.csv")
...
write.csv(Ha,"NonNut_FPro_p_val_&coef_final_statistics_with_KNHANES_F15-49-nonNutrient-svyglm.csv")
