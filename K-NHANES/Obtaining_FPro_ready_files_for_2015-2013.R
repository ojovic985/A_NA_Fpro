#Using F_codes_nutr_cont_per_100g files for years 2015-2013, and Train_36nutr.csv run:


A<-read.csv("F_codes_nutr_cont_per_100g_of_hn15_24rc.csv",header=TRUE)

A<-A[,-1]
A<-na.omit(A)
B<-read.csv("Train_36nutr.csv",header=TRUE)
B<-B[,-1]
...
colnames(A3)<-c("Water","Protein","Total.Fat","Fatty.acids..total.saturated","Fatty.acids..total.monounsaturated","Fatty.acids..total.polyunsaturated","X10.00","X12.00","X14.00","X16.00","X18.00","X16.01","X18.01","X20.01","X22.01","X18.02","X18.04","X20.04","X20.5.n.3","X22.5.n.3","X22.6.n.3","Cholesterol","Carbohydrate","Fiber..total.dietary","Calcium","Phosphorus","Iron","Sodium","Potassium","Carotene..beta","Retinol","Thiamin","Riboflavin","Niacin","Vitamin.C","N_FCODE","X18.03")
...
write.csv(A5,"Adjusted_F_codes_nutr_cont_in_gram_per_100g_of_hn15_24rc.csv")
write.csv(A6,"log_ie_FPro-ready_F_codes_nutr_cont­_of_hn15_24rc.csv")



A<-read.csv("F_codes_nutr_cont_per_100g_of_hn14_24rc.csv",header=TRUE)
...
write.csv(A5,"Adjusted_F_codes_nutr_cont_in_gram_per_100g_of_hn14_24rc.csv")
write.csv(A6,"log_ie_FPro-ready_F_codes_nutr_cont­_of_hn14_24rc.csv")



A<-read.csv("F_codes_nutr_cont_per_100g_of_hn13_24rc.csv",header=TRUE)
...
write.csv(A5,"Adjusted_F_codes_nutr_cont_in_gram_per_100g_of_hn13_24rc.csv")
write.csv(A6,"log_ie_FPro-ready_F_codes_nutr_cont­_of_hn13_24rc.csv")
